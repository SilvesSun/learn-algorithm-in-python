...
class Solution:
    def superEggDrop(self, k: int, n: int) -> int:
        ...
        #
        # 如果鸡蛋不碎，那么状态变成 (k, n-x)，即我们鸡蛋的数目不变，但答案只可能在上方的 n-x 层楼了。也就是说，我们把原问题缩小成了一个规模为
        # (k, n-x) 的子问题；
        #
        # 如果鸡蛋碎了，那么状态变成 (k-1, x-1)，即我们少了一个鸡蛋，但我们知道答案只可能在第 x 楼下方的 x-1 层楼中了。也就是说，
        # 我们把原问题缩小成了一个规模为 (k-1, x-1) 的子问题。
